...
import { ChatFeaturePlugin } from './chat-feature/chat-feature.plugin';
...
export const config: VendureConfig = {
    ...
    plugins: [
        ...
        ChatwootApiPlugin.init({
            ...
            agentApiToken: process.env.CHATWOOT_AGENT_API_TOKEN,
            ...
            enforceUserIdentity: process.env.CHATWOOT_ENFORCE_USER_IDENTITY === 'true',
            agentAccountId: process.env.CHATWOOT_AGENT_ACCOUNT_ID ? Number(process.env.CHATWOOT_AGENT_ACCOUNT_ID) : undefined,
        }),
        ChatFeaturePlugin.init({}),
    ],
};
